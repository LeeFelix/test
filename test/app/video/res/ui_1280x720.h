#ifndef __UI_1280X720_H__
#define __UI_1280X720_H__
...
#define WATERMARK_TIME_X    ((WIN_W - WATERMARK_TIME_W) & 0xfffffff0) //1104
#define WATERMARK_TIME_Y    ((TOPBK_IMG_H + 15) & 0xfffffff0) //64

#define WATERMARK_IMG_W    96
#define WATERMARK_IMG_H    32
#define WATERMARK_IMG_X    ((WIN_W - WATERMARK_IMG_W - 16) & 0xfffffff0) //1168
