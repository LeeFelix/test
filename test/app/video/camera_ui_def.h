...
#define IDM_DEBUG_VIDEO_BIT_RATE 250

#define IDM_DEBUG_VIDEO_BIT_RATE1 (IDM_DEBUG_VIDEO_BIT_RATE + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE2 (IDM_DEBUG_VIDEO_BIT_RATE1 + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE4 (IDM_DEBUG_VIDEO_BIT_RATE2 + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE6 (IDM_DEBUG_VIDEO_BIT_RATE4 + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE8 (IDM_DEBUG_VIDEO_BIT_RATE6 + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE10 (IDM_DEBUG_VIDEO_BIT_RATE8 + 1)
#define IDM_DEBUG_VIDEO_BIT_RATE12 (IDM_DEBUG_VIDEO_BIT_RATE10 + 1)
#define IDM_WIFI (IDM_DEBUG_VIDEO_BIT_RATE12 + 1)
